    ...
    return (
        <div id="wrapper">
            <div id="page" class="container">
                <div class="row1" style={{ backgroundImage: "url(/images/cctv2.jpg)" }}>
                    <h2>CCTV</h2>
                    <p>
                ...
                <div class="row">
                    <div class="col-12 m-auto">
                        <div class="title" style={{ margin: "0em 0em 0em 1em" }}>
                            <center><h2>CCTV Technologies</h2></center>
                        </div>
                    </div>
                </div>
                <hr />
                <div class="row">
                    <div id="testofa7" class="col-lg-12 col-12">
                        ...
                        <div id="ofa7" style={{ top: "10px", position: "absolute" }}>
                            <h2 style={{ padding: "40px", paddingTop: "100px", paddingBottom: "0px", color: "white" }}>
                                HD Cameras
                            </h2>
